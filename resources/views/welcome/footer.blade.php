                            ...
                            <div class="d-flex flex-column justify-content-between h-100">
                                ...
                                <div class="contact-social">
                                    ...
                                    <ul class="social-links">
                                        <li><a href="https://www.facebook.com/maharlikacoin" target="_blank"><i
                                                    class="fab fa-facebook-square"></i></a></li>
                                        <li><a href="https://medium.com/@maharlikacoin" target="_blank"><i
                                                    class="fab fa-medium"></i></a></li>
                                        <li><a href="https://twitter.com/maharlikacoin" target="_blank"><i
                                                    class="fab fa-twitter-square"></i></a></li>
                                        <li><a href="https://t.me/themaharlikacoin" target="_blank"><i
                                                    class="fab fa-telegram-plane"></i></a></li>
                                        <li><a href="https://www.reddit.com/user/maharlikacoin" target="_blank"><i
                                                    class="fab fa-reddit-square"></i></a></li>
                                        <li><a href="https://github.com/maharlikacoin" target="_blank"><i
                        ...
                        <div class="wgs wgs-text">
                            <div class="wgs-body">
                                <a href="./" class="wgs-logo">
                                    <img src="images/logo-full-white.png" srcset="images/logo-full-white2x.png 2x"
                                         alt="logo">
                                </a>
